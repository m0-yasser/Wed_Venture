...
class Suitshop extends StatefulWidget {
  const Suitshop({super.key});

  @override
  _SuitshopState createState() => _SuitshopState();
}
class _SuitshopState extends State<Suitshop> {
  @override
  Widget build(BuildContext context) {
      return Scaffold(
        ...
        body: SingleChildScrollView(
          child: Column(
            children: [
              const appBar(pageName: 'Suit shops'),
              SizedBox(
                height: 535,
                child: ListView(
                  children: [
