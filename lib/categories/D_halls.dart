...
class Dhalls extends StatefulWidget {
  final data;
  const Dhalls({super.key, this.data});

  @override
  _DhallsState createState() => _DhallsState();
}
class _DhallsState extends State<Dhalls> {
  @override
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      Icon(
                        Icons.location_pin, // You can use any bullet point icon you prefer
                        color: Colors.white,
                        size: 24,
                      ),
                      const Text(
